...
func TestIndexNE(t *testing.T) {
	...
	if cpu.ARM64.HasASIMD {
		t.Run("sse2", func(t *testing.T) { testfn(t, indexbyteneNEON) })
	}
}
...
func TestIndexNE64(t *testing.T) {
	...
	if cpu.ARM64.HasASIMD {
		t.Run("sse2", func(t *testing.T) { testfn64(t, indexbyteneNEON) })
	}
}
...
func BenchmarkIndexNE(b *testing.B) {
	...
	if cpu.ARM64.HasASIMD {
		b.Run("sse2", func(b *testing.B) { benchfn(b, indexbyteneNEON) })
	}
}
