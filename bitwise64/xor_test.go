...
func init() {
	...
	for i := 10; i < 1e9; i *= 10 {
		...
		stagesXorBytes = append(stagesXorBytes, stageBytes{a, b, res})
	}
}
...
func TestXorBytes(t *testing.T) {
	testfnBytes(t, stagesXorBytes, XorBytes)
}
...
func BenchmarkXorBytes(b *testing.B) {
	benchfnBytes(b, stagesXorBytes, XorBytes)
}
